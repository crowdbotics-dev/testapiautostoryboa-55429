...
## Project Structure
    ...
    ├── testapiautostoryboa_55429  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_55429`
...
2. Clone this repo and `cd testapiautostoryboa_55429`
